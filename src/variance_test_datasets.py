...
#
df1 = pd.read_csv('../data/preprocessed_mice_test/test_cirrhosis_0.csv')  # 52 patients
...
df2 = pd.read_csv('../data/preprocessed_mice_prospective/prospective_cirrhosis_0.csv')  # 284 patients
#
