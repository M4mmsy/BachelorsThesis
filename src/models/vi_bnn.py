...
def hypertrain_ensemble_vi_bnn(xs_train, ys_train, xs_val, ys_val, xs_test, ys_test, df_cols,
...
def evaluate_ensemble_vi_bnn(xs_test, ys_test, df_cols, shap_selected,
                             model_name='vi_bnn'):
    models = []
    ...
    evaluate_performance(models, xs_pro, ys_pro, df_cols, model_name, prospective)
